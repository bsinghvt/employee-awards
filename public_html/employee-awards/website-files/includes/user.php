...
class User extends DatabaseObject {
    ...
    protected static $select_query_all = 'SELECT User_Account.uid, User_Account.first_name, User_Account.user_email, User_Account.last_name, User_Account.middle_name, User_Account.creation, User_Account.job_title, User_Account.signature, CASE WHEN Award.adid IS NULL THEN 0 ELSE COUNT( Award.adid ) END AS total_awards FROM User_Account LEFT JOIN Award ON User_Account.uid = Award.uid GROUP BY User_Account.uid';
